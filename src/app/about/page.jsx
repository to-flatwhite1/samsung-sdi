        ...
        <div className="mx-auto mt-32 max-w-7xl sm:mt-40 sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            ...
            <div className="mx-auto mt-20 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-12 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:max-w-4xl lg:grid-cols-5">
              <Image
                alt="Transistor"
                src="https://tailwindui.com/plus/Image/logos/158x48/transistor-logo-white.svg"
                width={158}
                height={48}
              ...
              <Image
                alt="Reform"
                src="https://tailwindui.com/plus/Image/logos/158x48/reform-logo-white.svg"
                width={158}
                height={48}
                className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
              />
              <Image
                alt="Tuple"
                src="https://tailwindui.com/plus/Image/logos/158x48/tuple-logo-white.svg"
                width={158}
                height={48}
                className="col-span-2 max-h-12 w-full object-contain lg:col-span-1"
              />
              <Image
                alt="SavvyCal"
                src="https://tailwindui.com/plus/Image/logos/158x48/savvycal-logo-white.svg"
                width={158}
                height={48}
              ...
              <Image
                alt="Statamic"
                src="https://tailwindui.com/plus/Image/logos/158x48/statamic-logo-white.svg"
                width={158}
                height={48}
